(function() {
  ...
  */
  ...
  $log, $timeout, notificationService, routesSvc) {
    ...
    * @param {Object} route
    */
    UtilsRoute.createRouteSync = function(event, route) {
    ...
    * @method syncRoutes
    */
    UtilsRoute.syncRoutes = function() {
        ...
        _.each($localStorage.routes, function(route) {
          switch (route.$sync) {
            ...
            case 'update':
              ...
              UtilsRoute.saveRoute(route, true).then(function(routeId) {
              ...
              break
            case 'delete':
              UtilsRoute.deleteRoute(route, true).then(function(routeId) {
                intervalDelay = 60000 // 1 minute
                delete route.$sync
                $rootScope.$broadcast('routesUpdated', routeId)
              })
    ...
    */
    UtilsRoute.createTimeout = function() {
      if (canCreateTimeout) {
        canCreateTimeout = false
        $timeout(UtilsRoute.syncRoutes, intervalDelay)
        intervalDelay *= 2
      }
    }
    ...
    */
    UtilsRoute.getRoutes = function(forceRefresh) {
    ...
    */
    UtilsRoute.saveRoute = function(sourceRoute, silentWhenError) {
      var deferred = $q.defer()
    ...
    */
    UtilsRoute.deleteRoute = function(route, silentWhenError) {
      var deferred = $q.defer()
      ...
      .catch(function() {
        ...
        UtilsRoute.createRouteSync('delete', route)
        deferred.reject(false)
      })
    ...
    * @return {String}
    */
    UtilsRoute.getIconStatus = function(route) {
    ...
    * @return {String}
    */
    UtilsRoute.getIconRock = function(route) {
      if (!(route && route.rock)) {
        return 'fa-connectdevelop'
      }
    ...
    * @return {String}
    */
    UtilsRoute.getIndoorLabel = function(route) {
